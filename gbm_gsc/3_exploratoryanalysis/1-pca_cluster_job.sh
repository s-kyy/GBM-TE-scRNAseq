...
Rscript --vanilla ./1-pca_cluster.R ../2_seuratqc/20241122_merged_bhaduriGBM_wangGBM/20241203_gbm_int_umap/merged_ge_qc_integrated_umap.rds >gbm_ge_pca.out 2>&1
fi
...
Rscript --vanilla ./1-pca_cluster.R ../2_seuratqc/20241122_merged_bhaduriGBM_wangGBM/20241203_gbm_int_umap/merged_gte_qc_integrated_umap.rds >gbm_gte_pca.out 2>&1
fi
...
Rscript --vanilla ./1-pca_cluster.R ../2_seuratqc/20230320_healthy/20241203_healthy_int_umap/ge_qc_integrated_umap.rds >healthy_ge_pca.out 2>&1
fi
...
Rscript --vanilla ./1-pca_cluster.R ../2_seuratqc/20230320_healthy/20241203_healthy_int_umap/gte_qc_integrated_umap.rds >healthy_gte_pca.out 2>&1
fi
