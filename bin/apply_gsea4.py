...
# Python v3.7.9 
#     Cedar: ~/bin/Python-3.8.2/python
#     Local: C:\Users\Sam\AppData\Local\Programs\Python\Python37\python.exe

# Author: Samantha Yuen
# Adapted from: apply_cellranger6.py
# Created: Tuesday May 18, 2021
# Modified: Thursday May 20, 2021
...
def main():
    ...
    tmp = tmpdir + "/" + os.path.splitext(os.path.basename(res))[0] + datetime.now().strftime("%Y-%m-%d_%Hh%Mm") + ".sh"
