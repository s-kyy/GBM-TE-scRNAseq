...
ggsave("figs_ge_FeaturePlots_glutamate-receptors_genecard_251-.tiff", plot = p, units="in", width=size*2, height=size*1, dpi=300, compression = 'lzw')
...
#         [1] conflicted_1.1.0   gridExtra_2.3      dplyr_1.0.10       Seurat_4.2.0       sp_1.5-0           SeuratObject_4.1.2
# [7] ggplot2_3.3.6     
# 
# loaded via a namespace (and not attached):
#         [1] Rtsne_0.16            colorspace_2.0-3      deldir_1.0-6          ellipsis_0.3.2        ggridges_0.5.4       
# [6] rstudioapi_0.14       spatstat.data_3.0-0   farver_2.1.1          leiden_0.4.3          listenv_0.8.0        
# [11] ggrepel_0.9.1         fansi_1.0.3           codetools_0.2-18      splines_4.2.2         cachem_1.0.6         
# [16] knitr_1.40            polyclip_1.10-4       jsonlite_1.8.3        ica_1.0-3             cluster_2.1.4        
# [21] png_0.1-7             rgeos_0.5-9           uwot_0.1.14           shiny_1.7.3           sctransform_0.3.5    
# [26] spatstat.sparse_3.0-0 compiler_4.2.2        httr_1.4.4            assertthat_0.2.1      Matrix_1.5-1         
# [31] fastmap_1.1.0         lazyeval_0.2.2        cli_3.4.1             later_1.3.0           htmltools_0.5.3      
# [36] tools_4.2.2           igraph_1.3.5          gtable_0.3.1          glue_1.6.2            RANN_2.6.1           
# [41] reshape2_1.4.4        Rcpp_1.0.9            scattermore_0.8       vctrs_0.5.0           nlme_3.1-160         
# [46] progressr_0.11.0      lmtest_0.9-40         spatstat.random_3.0-1 xfun_0.34             stringr_1.4.1        
# [51] globals_0.16.1        mime_0.12             miniUI_0.1.1.1        lifecycle_1.0.3       irlba_2.3.5.1        
# [56] goftest_1.2-3         future_1.28.0         MASS_7.3-58.1         zoo_1.8-11            scales_1.2.1         
# [61] spatstat.core_2.4-4   promises_1.2.0.1      spatstat.utils_3.0-1  parallel_4.2.2        RColorBrewer_1.1-3   
# [66] yaml_2.3.6            memoise_2.0.1         reticulate_1.26       pbapply_1.5-0         rpart_4.1.19         
# [71] stringi_1.7.8         rlang_1.0.6           pkgconfig_2.0.3       matrixStats_0.62.0    evaluate_0.17        
# [76] lattice_0.20-45       ROCR_1.0-11           purrr_0.3.5           tensor_1.5            labeling_0.4.2       
# [81] patchwork_1.1.2       htmlwidgets_1.5.4     cowplot_1.1.1         tidyselect_1.2.0      parallelly_1.32.1    
# [86] RcppAnnoy_0.0.20      plyr_1.8.7            magrittr_2.0.3        R6_2.5.1              generics_0.1.3       
# [91] DBI_1.1.3             mgcv_1.8-41           pillar_1.8.1          withr_2.5.0           fitdistrplus_1.1-8   
# [96] survival_3.4-0        abind_1.4-5           tibble_3.1.8          future.apply_1.9.1    crayon_1.5.2         
# [101] KernSmooth_2.23-20    utf8_1.2.2            spatstat.geom_3.0-3   plotly_4.10.1         rmarkdown_2.17       
# [106] grid_4.2.2            data.table_1.14.4     digest_0.6.30         xtable_1.8-4          tidyr_1.2.1          
# [111] httpuv_1.6.6          munsell_0.5.0         viridisLite_0.4.1
