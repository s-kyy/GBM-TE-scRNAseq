...
# p
ggsave("fig_gsc_ge_umigenemitoratio.tiff", plot = p, units="in", width=size*1.2, height=size*0.5, dpi=300, compression = 'lzw')
...
p <- gte_gbmsc@meta.data %>% 
    ...
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1), axis.title.y = element_text(size=11, hjust=0.8), 
          ...
          panel.border = element_rect(fill = NA, colour = "black"))
# p
ggsave("fig_gsc_gte_umigenemitoratio.tiff", plot = p, units="in", width=size*1.2, height=size*0.5, dpi=300, compression = 'lzw')


## Genes x Cells (violin plot)
## UMI x Cell (violin plot)
```
...
p <- ge_meta%>% 
    ...
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1), 
          ...
          panel.border = element_rect(fill = NA, colour = "black"))
# p
ggsave("fig_gbm_ge_umigenemitoratio.tiff", plot = p, units="in", width=size*1.2, height=size*0.8, dpi=300, compression = 'lzw')
...
p <- gte_meta %>% 
    ...
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
          ...
          panel.border = element_rect(fill = NA, colour = "black"))
# p
ggsave("fig_gbm_gte_umigenemitoratio.tiff", plot = p, units="in", width=size*1.2, height=size*0.8, dpi=300, compression = 'lzw')
```
