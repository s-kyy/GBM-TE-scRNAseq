...
samplePalette <- c("#E69F00", "#56B4E9", "#009E73", "#F0E442", "#CC79A7", "#ff716e", 
                   "#999999", "#0072B2", "#194c76", "#D55E00")
...
p <- data@meta.data %>% 
  ...
  scale_fill_manual(values = samplePalette) +
  labs(fill="Samples", color="Samples", y = "Cell Density", x = "log10 Genes+TE per UMI") +
	theme_classic() +
	geom_vline(xintercept = 0.8, linetype = "dashed", colour = "red") 
p
ggsave("fig_gbmgsc_gte_log10GenesUMI_density.tiff", plot = p, units="in", width=size*0.9, height=size*0.5, dpi=300, compression = 'lzw')
```
